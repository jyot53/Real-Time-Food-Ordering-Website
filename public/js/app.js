...
var addtodart = document.querySelectorAll('.addtocart');
...
addtodart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); // console.log(pizza.name);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkRealTimeCoffeeOrder"] = self["webpackChunkRealTimeCoffeeOrder"] || [];
